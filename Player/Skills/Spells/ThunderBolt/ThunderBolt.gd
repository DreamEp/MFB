...
var thunder_scene: PackedScene = preload("res://Player/Skills/Spells/ThunderBolt/thunder.tscn")
...
func spawnThunderBolt(enemies_in_range):
	...
	var thunder_rate = thunder_spell_rate - (thunder_spell_rate * (player.attack_speed/100))
	var current_enemy = 0
